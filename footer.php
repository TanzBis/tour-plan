      ...
      <div class="footer__social-network">
        ...
        <div class="footer__social-links">
          <a
            ...
            target="_blank"
          >
            <img src="img/footer-icon/fb.svg" alt="icon: facebook" />
          </a>
          <a
            ...
            target="_blank"
          >
            <img src="img/footer-icon/yt.svg" alt="icon: youtube" />
          </a>
          <a
            ...
            target="_blank"
          >
            <img src="img/footer-icon/inst.svg" alt="icon: instagram" />
          </a>
        </div>
        ...
        <ul class="footer__ul footer__contact-ul">
          ...
          <li class="footer__item footer__item--mb-2">
            <div class="footer__icon-wrapper">
              <img
                class="footer__icon"
                src="img/footer-icon/contact-phone.svg"
                alt="icon: phone call"
              />
            </div>
          ...
          <li class="footer__item footer__item--mb-2">
            <div class="footer__icon-wrapper">
              <img
                class="footer__icon"
                src="img/footer-icon/mail-marker.svg"
                alt="icon: email"
              />
            </div>
